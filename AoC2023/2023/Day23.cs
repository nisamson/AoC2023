...
public class Day23 : Adventer {
    ...
    public class Mountain {
        ...
        public IEnumerable<Vertex> LongestHike() {
            if (IsCyclic()) {
                return LongestHikeNoCycles();
            }

            var alg = new LongestSimplePathAlgorithm<Vertex, Edge<Vertex>, BidirectionalMatrixGraph<Vertex, Edge<Vertex>>>(
                graph,
                Start,
                End,
        ...
        private IEnumerable<Vertex> LongestHikeNoCycles() {
            ...
            if (!alg.Invoke(End, out var path)) {
