...
public class KnownPopulationSet<T> : ISet<T> where T : notnull {
    ...
    public class Generator {
        ...
        public Generator(IEnumerable<T> population, IEqualityComparer<T> comparer) {
            ...
            populationIndices = this.population.Select((v, i) => (v, i)).ToFrozenDictionary(x => x.v, x => x.i, comparer);
    ...
    public bool IsProperSupersetOf(IEnumerable<T> other) {
        if (other is KnownPopulationSet<T> kps && kps.generator == generator) {
            return kps.IsProperSubsetOf(this);
        }
...
public static class KnownPopulationSet {
    public static KnownPopulationSet<T>.Generator CreateGenerator<T>(IEnumerable<T> population, IEqualityComparer<T>? comparer = null)
        where T : notnull {
